...
def save_to_md():
    ...
    with open ('graph.md', 'w', encoding='utf-8') as file:
        ...
        file.write(f'![Incidents 85-99](incidents_85_99_over_Airlines.png)\n\n')
        file.write(f'![Incidents 85-99](Frequency_of_incidents_85_99_histogram.png)\n\n')
        file.write(f'### Fatal Accidents 85-99\n\n')
        file.write(f'![Fatal Accidents 85-99](fatal_accidents_85_99_over_Airlines.png)\n\n')
        file.write(f'![Fatal Accidents 85-99](Frequency_of_fatal_accidents_85_99_histogram.png)\n\n')
        file.write(f'### Fatalities 85-99\n\n')
        file.write(f'![Fatalities 85-99](fatalities_85_99_over_Airlines.png)\n\n')
        file.write(f'![Fatalities 85-99](Frequency_of_fatalities_85_99_histogram.png)\n\n')
        file.write(f'### Incidents 00-14\n\n')
        file.write(f'![Incidents 00-14](incidents_00_14_over_Airlines.png)\n\n')
        file.write(f'![Incidents 00-14](Frequency_of_incidents_00_14_histogram.png)\n\n')
        file.write(f'### Fatal Accidents 00-14\n\n')
        file.write(f'![Fatal Accidents 00-14](fatal_accidents_00_14_over_Airlines.png)\n\n')
        file.write(f'![Fatal Accidents 00-14](Frequency_of_fatal_accidents_00_14_histogram.png)\n\n')
        file.write(f'### Fatalities 00-14\n\n')
        file.write(f'![Fatalities 00-14](fatalities_00_14_over_Airlines.png)\n\n')
        file.write(f'![Fatalities 00-14](Frequency_of_fatalities_00_14_histogram.png)\n\n')
